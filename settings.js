...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PRABATH-MD~pStyUIbb#KMjMbGEE_w-zTqqsfL984oGfYm3hxwmBb3IovTLfjUI' : process.env.SESSION_ID,
...
HEART_REACT: process.env.HEART_REACT || 'false',
    SUDO: process.env.SUDO === undefined ? '94712438904,94771820962' : process.env.SUDO,
